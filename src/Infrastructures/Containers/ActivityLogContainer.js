...
export default function registerActivityLogContainer({ container, overrides = {}, prisma }) {
	...
	const listActivityLogsUsecase =
		overrides.listActivityLogsUsecase ?? new ListActivityLogsUsecase({ activityLogService });
	...
	const createActivityLogUsecase =
		overrides.createActivityLogUsecase ?? new CreateActivityLogUsecase({ activityLogService });
	const deleteActivityLogUsecase =
		overrides.deleteActivityLogUsecase ?? new DeleteActivityLogUsecase({ activityLogService });
	const activityLogPresenter = overrides.activityLogPresenter ?? new ActivityLogPresenter();
	const activityLogController =
		overrides.activityLogController ??
