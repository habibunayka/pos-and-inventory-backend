...
export default function registerPromotionContainer({ container, overrides = {}, prisma }) {
	...
	const promotionController =
		overrides.promotionController ??
		new PromotionController({
			presenter: promotionPresenter,
			listUsecase: listPromotionsUsecase,
			getUsecase: getPromotionUsecase,
			createUsecase: createPromotionUsecase,
			updateUsecase: updatePromotionUsecase,
			deleteUsecase: deletePromotionUsecase
		});
