...
} from "../../Applications/DeliveryIntegrations/UseCases/index.js";
...
export default function registerDeliveryIntegrationContainer({ container, overrides = {}, prisma }) {
	const deliveryIntegrationRepository =
		overrides.deliveryIntegrationRepository ?? new PrismaDeliveryIntegrationRepository({ prisma });
	const deliveryIntegrationService =
		overrides.deliveryIntegrationService ?? new DeliveryIntegrationService({ deliveryIntegrationRepository });
	const listDeliveryIntegrationsUsecase =
		overrides.listDeliveryIntegrationsUsecase ??
		new ListDeliveryIntegrationsUsecase({ deliveryIntegrationService });
	const getDeliveryIntegrationUsecase =
		overrides.getDeliveryIntegrationUsecase ?? new GetDeliveryIntegrationUsecase({ deliveryIntegrationService });
	const createDeliveryIntegrationUsecase =
		overrides.createDeliveryIntegrationUsecase ??
		new CreateDeliveryIntegrationUsecase({ deliveryIntegrationService });
	const updateDeliveryIntegrationUsecase =
		overrides.updateDeliveryIntegrationUsecase ??
		new UpdateDeliveryIntegrationUsecase({ deliveryIntegrationService });
	const deleteDeliveryIntegrationUsecase =
		overrides.deleteDeliveryIntegrationUsecase ??
		new DeleteDeliveryIntegrationUsecase({ deliveryIntegrationService });
	...
	const deliveryIntegrationController =
		overrides.deliveryIntegrationController ??
		new DeliveryIntegrationController({
