...
export default class DeliveryIntegrationService {
	...
	getDeliveryIntegration(id) {
		return this._repo.findById(id);
	}
	createDeliveryIntegration(data) {
		return this._repo.createDeliveryIntegration(data);
	}
	updateDeliveryIntegration(payload) {
		return this._repo.updateDeliveryIntegration(payload);
	}
	deleteDeliveryIntegration(id) {
		return this._repo.deleteDeliveryIntegration(id);
	}
}
