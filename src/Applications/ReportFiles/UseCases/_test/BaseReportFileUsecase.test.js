...
class DummyUsecase extends BaseReportFileUsecase {}

describe("BaseReportFileUsecase", () => {
	test("should throw when service missing", () => {
		expect(() => new BaseReportFileUsecase()).toThrow("REPORTFILE_USECASE.MISSING_SERVICE");
	});

	test("_toInt should convert valid ids", () => {
		const usecase = new DummyUsecase({ reportFileService: {} });
