...
export default class PlaceStockService {
	...
	createPlaceStock(data) {
		return this._repo.createPlaceStock(data);
	}
	updatePlaceStock({ id, data }) {
		return this._repo.updatePlaceStock({ id, data });
	}
	deletePlaceStock(id) {
		return this._repo.deletePlaceStock(id);
	}
}
