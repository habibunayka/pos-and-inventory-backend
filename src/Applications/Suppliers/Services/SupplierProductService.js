...
export default class SupplierProductService {
	...
	listSupplierProducts() {
		return this._supplierProductRepository.findAll();
	}
	getSupplierProduct(id) {
		return this._supplierProductRepository.findById(id);
	}
	createSupplierProduct(data) {
		return this._supplierProductRepository.createSupplierProduct(data);
	}
	updateSupplierProduct(payload) {
		return this._supplierProductRepository.updateSupplierProduct(payload);
	}
	deleteSupplierProduct(id) {
		return this._supplierProductRepository.deleteSupplierProduct(id);
	}
}
