	...
	return {
		...
		paths: {
			...
			"/api/ingredients": {
				...
				post: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/CreateIngredientRequest" } }
						}
					},
					responses: {
						201: {
			...
			"/api/ingredients/{id}": {
				...
				put: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/UpdateIngredientRequest" } }
						}
					},
					responses: {
						200: {
			...
			"/api/packages": {
				...
				post: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/CreatePackageRequest" } }
						}
					},
					responses: {
						201: {
			...
			"/api/categories/{id}": {
				...
				delete: {
					...
					responses: {
						204: { description: "Kategori dihapus" },
						400: { $ref: "#/components/responses/BadRequest" },
						404: { $ref: "#/components/responses/NotFound" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/menu-prices": {
				get: {
					...
					responses: {
						200: {
							...
							content: {
								"application/json": {
									schema: { type: "array", items: { $ref: "#/components/schemas/MenuPrice" } }
								}
							}
						},
						500: { $ref: "#/components/responses/InternalServerError" }
				...
				post: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/CreateMenuPriceRequest" } }
						}
					},
					responses: {
						201: {
							description: "Harga dibuat",
							content: { "application/json": { schema: { $ref: "#/components/schemas/MenuPrice" } } }
						},
						400: { $ref: "#/components/responses/BadRequest" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/menu-prices/{id}": {
				...
				put: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/UpdateMenuPriceRequest" } }
						}
					},
					responses: {
						200: {
			...
			"/api/menu-variants": {
				get: {
					...
					responses: {
						200: {
							...
							content: {
								"application/json": {
									schema: { type: "array", items: { $ref: "#/components/schemas/MenuVariant" } }
								}
							}
						},
						500: { $ref: "#/components/responses/InternalServerError" }
				...
				post: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/CreateMenuVariantRequest" } }
						}
					},
					responses: {
						201: {
			...
			"/api/menu-variants/{id}": {
				...
				put: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/UpdateMenuVariantRequest" } }
						}
					},
					responses: {
						200: {
				...
				delete: {
					...
					responses: {
						204: { description: "Varian dihapus" },
						400: { $ref: "#/components/responses/BadRequest" },
						404: { $ref: "#/components/responses/NotFound" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/menu-variant-items": {
				get: {
					...
					responses: {
						200: {
							...
							content: {
								"application/json": {
									schema: { type: "array", items: { $ref: "#/components/schemas/MenuVariantItem" } }
								}
							}
						},
						500: { $ref: "#/components/responses/InternalServerError" }
				...
				post: {
					...
					requestBody: {
						...
						content: {
							"application/json": {
								schema: { $ref: "#/components/schemas/CreateMenuVariantItemRequest" }
							}
						}
					},
					responses: {
						201: {
							...
							content: {
								"application/json": { schema: { $ref: "#/components/schemas/MenuVariantItem" } }
							}
						},
						400: { $ref: "#/components/responses/BadRequest" },
						500: { $ref: "#/components/responses/InternalServerError" }
			...
			"/api/menu-variant-items/{id}": {
				...
				put: {
					...
					requestBody: {
						...
						content: {
							"application/json": {
								schema: { $ref: "#/components/schemas/UpdateMenuVariantItemRequest" }
							}
						}
					},
					responses: {
				...
				delete: {
					...
					responses: {
						204: { description: "Item varian dihapus" },
						400: { $ref: "#/components/responses/BadRequest" },
						404: { $ref: "#/components/responses/NotFound" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/recipes": {
				...
				post: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/CreateRecipeRequest" } }
						}
					},
					responses: {
						201: {
			...
			"/api/recipes/{id}": {
				...
				put: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/UpdateRecipeRequest" } }
						}
					},
					responses: {
						200: {
			...
			"/api/payment-methods": {
				...
				post: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/CreatePaymentMethodRequest" } }
						}
					},
					responses: {
						201: {
			...
			"/api/payment-methods/{id}": {
				...
				put: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/UpdatePaymentMethodRequest" } }
						}
					},
					responses: {
						200: {
				...
				delete: {
					...
					responses: {
						204: { description: "Metode dihapus" },
						400: { $ref: "#/components/responses/BadRequest" },
						404: { $ref: "#/components/responses/NotFound" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/delivery-integrations": {
						...
						200: {
							...
							content: {
								"application/json": {
									schema: {
										type: "array",
										items: { $ref: "#/components/schemas/DeliveryIntegration" }
									}
								}
							}
						},
				...
				post: {
					...
					requestBody: {
						...
						content: {
							"application/json": {
								schema: { $ref: "#/components/schemas/CreateDeliveryIntegrationRequest" }
							}
						}
					},
					responses: {
						201: {
							...
							content: {
								"application/json": { schema: { $ref: "#/components/schemas/DeliveryIntegration" } }
							}
						},
						400: { $ref: "#/components/responses/BadRequest" },
						500: { $ref: "#/components/responses/InternalServerError" }
			...
			"/api/delivery-integrations/{id}": {
				...
				put: {
					...
					requestBody: {
						...
						content: {
							"application/json": {
								schema: { $ref: "#/components/schemas/UpdateDeliveryIntegrationRequest" }
							}
						}
					},
					responses: {
				...
				delete: {
					...
					responses: {
						204: { description: "Integrasi dihapus" },
						400: { $ref: "#/components/responses/BadRequest" },
						404: { $ref: "#/components/responses/NotFound" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/report-files": {
				...
				post: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/CreateReportFileRequest" } }
						}
					},
					responses: {
						201: {
							description: "Record dibuat",
							content: { "application/json": { schema: { $ref: "#/components/schemas/ReportFile" } } }
						},
						400: { $ref: "#/components/responses/BadRequest" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/report-files/{id}": {
				...
				put: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/UpdateReportFileRequest" } }
						}
					},
					responses: {
						200: {
				...
				delete: {
					...
					responses: {
						204: { description: "Record dihapus" },
						400: { $ref: "#/components/responses/BadRequest" },
						404: { $ref: "#/components/responses/NotFound" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/activity-logs": {
				...
				post: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/CreateActivityLogRequest" } }
						}
					},
					responses: {
						201: {
							description: "Log dibuat",
							content: { "application/json": { schema: { $ref: "#/components/schemas/ActivityLog" } } }
						},
						400: { $ref: "#/components/responses/BadRequest" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/system-logs": {
				get: {
					...
					responses: {
						200: {
							...
							content: {
								"application/json": {
									schema: { type: "array", items: { $ref: "#/components/schemas/SystemLog" } }
								}
							}
						},
						500: { $ref: "#/components/responses/InternalServerError" }
				...
				post: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/CreateSystemLogRequest" } }
						}
					},
					responses: {
						201: {
							description: "Log dibuat",
							content: { "application/json": { schema: { $ref: "#/components/schemas/SystemLog" } } }
						},
						400: { $ref: "#/components/responses/BadRequest" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/packages/{id}": {
				...
				put: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/UpdatePackageRequest" } }
						}
					},
					responses: {
						200: {
			...
			"/api/ingredient-packages": {
				...
				post: {
					...
					requestBody: {
						...
						content: {
							"application/json": {
								schema: { $ref: "#/components/schemas/CreateIngredientPackageRequest" }
							}
						}
					},
					responses: {
						201: {
							...
							content: {
								"application/json": { schema: { $ref: "#/components/schemas/IngredientPackage" } }
							}
						},
						400: { $ref: "#/components/responses/BadRequest" },
						500: { $ref: "#/components/responses/InternalServerError" }
			...
			"/api/ingredient-packages/{id}": {
				...
				put: {
					...
					requestBody: {
						...
						content: {
							"application/json": {
								schema: { $ref: "#/components/schemas/UpdateIngredientPackageRequest" }
							}
						}
					},
					responses: {
				...
				delete: {
					...
					responses: {
						204: { description: "Relasi dihapus" },
						400: { $ref: "#/components/responses/BadRequest" },
						404: { $ref: "#/components/responses/NotFound" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/suppliers/{id}": {
				...
				put: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/UpdateSupplierRequest" } }
						}
					},
					responses: {
						200: {
				...
				delete: {
					...
					responses: {
						204: { description: "Pemasok dihapus" },
						400: { $ref: "#/components/responses/BadRequest" },
						404: { $ref: "#/components/responses/NotFound" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/supplier-products": {
				...
				post: {
					...
					requestBody: {
						...
						content: {
							"application/json": {
								schema: { $ref: "#/components/schemas/CreateSupplierProductRequest" }
							}
						}
					},
					responses: {
						201: {
							...
							content: {
								"application/json": { schema: { $ref: "#/components/schemas/SupplierProduct" } }
							}
						},
						400: { $ref: "#/components/responses/BadRequest" },
						500: { $ref: "#/components/responses/InternalServerError" }
			...
			"/api/supplier-products/{id}": {
				...
				put: {
					...
					requestBody: {
						...
						content: {
							"application/json": {
								schema: { $ref: "#/components/schemas/UpdateSupplierProductRequest" }
							}
						}
					},
					responses: {
				...
				delete: {
					...
					responses: {
						204: { description: "Produk pemasok dihapus" },
						400: { $ref: "#/components/responses/BadRequest" },
						404: { $ref: "#/components/responses/NotFound" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/place-stocks": {
				get: {
					...
					responses: {
						200: {
							...
							content: {
								"application/json": {
									schema: { type: "array", items: { $ref: "#/components/schemas/PlaceStock" } }
								}
							}
						},
						500: { $ref: "#/components/responses/InternalServerError" }
				...
				post: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/CreatePlaceStockRequest" } }
						}
					},
					responses: {
						201: {
							description: "Place stock dibuat",
							content: { "application/json": { schema: { $ref: "#/components/schemas/PlaceStock" } } }
						},
						400: { $ref: "#/components/responses/BadRequest" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/place-stocks/{id}": {
				...
				put: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/UpdatePlaceStockRequest" } }
						}
					},
					responses: {
						200: {
				...
				delete: {
					...
					responses: {
						204: { description: "Place stock dihapus" },
						400: { $ref: "#/components/responses/BadRequest" },
						404: { $ref: "#/components/responses/NotFound" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/inventory-stock-daily": {
						...
						200: {
							...
							content: {
								"application/json": {
									schema: {
										type: "array",
										items: { $ref: "#/components/schemas/InventoryStockDaily" }
									}
								}
							}
						},
				...
				post: {
					...
					requestBody: {
						...
						content: {
							"application/json": {
								schema: { $ref: "#/components/schemas/CreateInventoryStockDailyRequest" }
							}
						}
					},
					responses: {
						201: {
							...
							content: {
								"application/json": { schema: { $ref: "#/components/schemas/InventoryStockDaily" } }
							}
						},
						400: { $ref: "#/components/responses/BadRequest" },
						500: { $ref: "#/components/responses/InternalServerError" }
			...
			"/api/inventory-stock-daily/{id}": {
				...
				delete: {
					...
					responses: {
						204: { description: "Stok harian dihapus" },
						400: { $ref: "#/components/responses/BadRequest" },
						404: { $ref: "#/components/responses/NotFound" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/stock-transfers": {
				get: {
					...
					responses: {
						200: {
							...
							content: {
								"application/json": {
									schema: { type: "array", items: { $ref: "#/components/schemas/StockTransfer" } }
								}
							}
						},
						500: { $ref: "#/components/responses/InternalServerError" }
				...
				post: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/CreateStockTransferRequest" } }
						}
					},
					responses: {
						201: {
							description: "Transfer dibuat",
							content: { "application/json": { schema: { $ref: "#/components/schemas/StockTransfer" } } }
						},
						400: { $ref: "#/components/responses/BadRequest" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/stock-transfers/{id}": {
				...
				delete: {
					...
					responses: {
						204: { description: "Transfer dihapus" },
						400: { $ref: "#/components/responses/BadRequest" },
						404: { $ref: "#/components/responses/NotFound" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
				...
				get: {
					...
					responses: {
						200: {
							...
							content: {
								"application/json": {
									schema: { type: "array", items: { $ref: "#/components/schemas/Waste" } }
								}
							}
						},
						500: { $ref: "#/components/responses/InternalServerError" }
				...
				post: {
					...
					responses: {
						201: {
							...
							content: { "application/json": { schema: { $ref: "#/components/schemas/Waste" } } }
						},
						400: { $ref: "#/components/responses/BadRequest" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/cashier-shifts": {
				get: {
					...
					responses: {
						200: {
							...
							content: {
								"application/json": {
									schema: { type: "array", items: { $ref: "#/components/schemas/CashierShift" } }
								}
							}
						},
						500: { $ref: "#/components/responses/InternalServerError" }
				...
				post: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/CreateCashierShiftRequest" } }
						}
					},
					responses: {
						201: {
							description: "Shift dibuat",
							content: { "application/json": { schema: { $ref: "#/components/schemas/CashierShift" } } }
						},
						400: { $ref: "#/components/responses/BadRequest" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/cashier-shifts/{id}": {
				...
				put: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/UpdateCashierShiftRequest" } }
						}
					},
					responses: {
						200: {
			...
			"/api/promotions/{id}": {
				...
				delete: {
					...
					responses: {
						204: { description: "Promosi dihapus" },
						400: { $ref: "#/components/responses/BadRequest" },
						404: { $ref: "#/components/responses/NotFound" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/promotion-rules": {
				get: {
					...
					responses: {
						200: {
							...
							content: {
								"application/json": {
									schema: { type: "array", items: { $ref: "#/components/schemas/PromotionRule" } }
								}
							}
						},
						500: { $ref: "#/components/responses/InternalServerError" }
				...
				post: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/CreatePromotionRuleRequest" } }
						}
					},
					responses: {
						201: {
							description: "Aturan dibuat",
							content: { "application/json": { schema: { $ref: "#/components/schemas/PromotionRule" } } }
						},
						400: { $ref: "#/components/responses/BadRequest" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/promotion-rules/{id}": {
				...
				delete: {
					...
					responses: {
						204: { description: "Aturan dihapus" },
						400: { $ref: "#/components/responses/BadRequest" },
						404: { $ref: "#/components/responses/NotFound" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/transactions/{id}": {
				...
				delete: {
					...
					responses: {
						204: { description: "Transaksi dihapus" },
						400: { $ref: "#/components/responses/BadRequest" },
						404: { $ref: "#/components/responses/NotFound" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/transaction-items": {
				get: {
					...
					responses: {
						200: {
							...
							content: {
								"application/json": {
									schema: { type: "array", items: { $ref: "#/components/schemas/TransactionItem" } }
								}
							}
						},
						500: { $ref: "#/components/responses/InternalServerError" }
				...
				post: {
					...
					requestBody: {
						...
						content: {
							"application/json": {
								schema: { $ref: "#/components/schemas/CreateTransactionItemRequest" }
							}
						}
					},
					responses: {
						201: {
							...
							content: {
								"application/json": { schema: { $ref: "#/components/schemas/TransactionItem" } }
							}
						},
						400: { $ref: "#/components/responses/BadRequest" },
						500: { $ref: "#/components/responses/InternalServerError" }
			...
			"/api/transaction-items/{id}": {
				...
				put: {
					...
					requestBody: {
						...
						content: {
							"application/json": {
								schema: { $ref: "#/components/schemas/UpdateTransactionItemRequest" }
							}
						}
					},
					responses: {
			...
			"/api/transaction-item-variants": {
						...
						200: {
							...
							content: {
								"application/json": {
									schema: {
										type: "array",
										items: { $ref: "#/components/schemas/TransactionItemVariant" }
									}
								}
							}
						},
				...
				post: {
					...
					requestBody: {
						...
						content: {
							"application/json": {
								schema: { $ref: "#/components/schemas/CreateTransactionItemVariantRequest" }
							}
						}
					},
					responses: {
						201: {
							description: "Varian dibuat",
							content: {
								"application/json": { schema: { $ref: "#/components/schemas/TransactionItemVariant" } }
							}
						},
						400: { $ref: "#/components/responses/BadRequest" },
						500: { $ref: "#/components/responses/InternalServerError" }
			...
			"/api/kitchen-orders": {
				get: {
					...
					responses: {
						200: {
							...
							content: {
								"application/json": {
									schema: { type: "array", items: { $ref: "#/components/schemas/KitchenOrder" } }
								}
							}
						},
						500: { $ref: "#/components/responses/InternalServerError" }
				...
				post: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/CreateKitchenOrderRequest" } }
						}
					},
					responses: {
						201: {
							description: "Kitchen order dibuat",
							content: { "application/json": { schema: { $ref: "#/components/schemas/KitchenOrder" } } }
						},
						400: { $ref: "#/components/responses/BadRequest" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
			...
			"/api/kitchen-orders/{id}": {
				...
				put: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/UpdateKitchenOrderRequest" } }
						}
					},
					responses: {
						200: {
			...
			"/api/permissions": {
				...
				post: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/CreatePermissionRequest" } }
						}
					},
					responses: {
						201: {
			...
			"/api/permissions/{id}": {
				...
				put: {
					...
					requestBody: {
						required: true,
						content: {
							"application/json": { schema: { $ref: "#/components/schemas/UpdatePermissionRequest" } }
						}
					},
					responses: {
						200: {
				...
				delete: {
					...
					responses: {
						204: { description: "Permission dihapus" },
						400: { $ref: "#/components/responses/BadRequest" },
						404: { $ref: "#/components/responses/NotFound" },
						500: { $ref: "#/components/responses/InternalServerError" }
					}
		...
		components: {
			...
			schemas: {
				PlaceStock: {
					type: "object",
					required: ["id", "placeId", "ingredientId", "qty", "unitId"],
					properties: {
				...
				UpdatePlaceStockRequest: {
					...
					properties: {
						placeId: { type: "integer", example: 1 },
						ingredientId: { type: "integer", example: 2 },
						qty: { type: "number", example: 120 },
						unitId: { type: "integer", example: 1 }
					}
				},
				InventoryStockDaily: {
					type: "object",
					required: ["id", "placeId", "ingredientId", "date", "openingQty", "closingQty"],
					properties: {
						id: { type: "integer", example: 1 },
						placeId: { type: "integer", example: 1 },
						ingredientId: { type: "integer", example: 2 },
						date: { type: "string", format: "date", example: "2025-01-01" },
						openingQty: { type: "number", example: 100 },
						closingQty: { type: "number", example: 90 },
						diffQty: { type: "number", nullable: true, example: -10 }
					}
				},
				CreateInventoryStockDailyRequest: {
					type: "object",
					required: ["placeId", "ingredientId", "date", "openingQty", "closingQty"],
					properties: {
						placeId: { type: "integer", example: 1 },
						ingredientId: { type: "integer", example: 2 },
						date: { type: "string", format: "date", example: "2025-01-01" },
				...
				UpdateInventoryStockDailyRequest: {
					...
					properties: {
						...
						openingQty: { type: "number", example: 110 },
						closingQty: { type: "number", example: 95 },
						diffQty: { type: "number", nullable: true, example: -15 }
					}
				},
				StockTransfer: {
					type: "object",
					required: ["id", "ingredientId", "qty"],
					properties: {
						id: { type: "integer", example: 1 },
						ingredientId: { type: "integer", example: 2 },
						fromPlaceId: { type: "integer", nullable: true, example: 1 },
						toPlaceId: { type: "integer", nullable: true, example: 2 },
				...
				Waste: {
					...
					properties: {
						id: { type: "integer", example: 1 },
						ingredientId: { type: "integer", example: 3 },
						placeId: { type: "integer", nullable: true, example: 1 },
						qty: { type: "number", example: 2 },
						reason: { type: "string", nullable: true, example: "Expired" },
						createdAt: { type: "string", format: "date-time" }
					}
				},
				CreateWasteRequest: {
				...
				UpdateWasteRequest: {
					...
					properties: {
						...
						reason: { type: "string", nullable: true, example: "Broken" }
					}
				},
				CashierShift: {
					type: "object",
					required: ["id", "placeId", "cashierId", "openedAt", "status"],
					properties: {
						id: { type: "integer", example: 1 },
						placeId: { type: "integer", example: 1 },
						cashierId: { type: "integer", example: 2 },
				...
				CreateCashierShiftRequest: {
					type: "object",
					required: ["placeId", "cashierId", "ipAddress"],
					properties: {
						placeId: { type: "integer", example: 1 },
						cashierId: { type: "integer", example: 2 },
						ipAddress: { type: "string", example: "127.0.0.1" },
				...
				Promotion: {
					...
					properties: {
						id: { type: "integer", example: 1 },
						placeId: { type: "integer", nullable: true, example: 1 },
						name: { type: "string", example: "Happy Hour" },
				...
				UpdatePromotionRequest: {
					...
					properties: {
						placeId: { type: "integer", nullable: true, example: 1 },
						name: { type: "string", example: "Weekend Deal" },
						startAt: { type: "string", format: "date-time", nullable: true },
						endAt: { type: "string", format: "date-time", nullable: true }
					}
				},
				PromotionRule: {
					type: "object",
					required: ["id", "promotionId"],
					properties: {
						id: { type: "integer", example: 1 },
						promotionId: { type: "integer", example: 1 },
						ruleType: { type: "string", nullable: true, example: "percentage_discount" },
						value: { type: "string", nullable: true, example: "10" }
					}
				},
				...
				UpdatePromotionRuleRequest: {
					...
					properties: {
						promotionId: { type: "integer", example: 1 },
						ruleType: { type: "string", nullable: true, example: "amount_discount" },
						value: { type: "string", nullable: true, example: "5000" }
					}
				},
				Transaction: {
					type: "object",
					...
					properties: {
						...
						orderType: { type: "string", nullable: true, example: "dine_in" },
						total: { type: "number", example: 50000 },
						tax: { type: "number", nullable: true, example: 5000 },
						discount: { type: "number", nullable: true, example: 0 },
						paymentMethodId: { type: "integer", nullable: true, example: 1 },
						createdAt: { type: "string", format: "date-time" }
					}
				},
				...
				UpdateTransactionRequest: {
					...
					properties: {
						cashierId: { type: "integer", example: 2 },
						placeId: { type: "integer", nullable: true, example: 1 },
						tableId: { type: "integer", nullable: true, example: 4 },
						orderType: { type: "string", nullable: true, example: "takeaway" },
						total: { type: "number", example: 75000 },
						tax: { type: "number", nullable: true, example: 7500 },
						discount: { type: "number", nullable: true, example: 5000 },
						paymentMethodId: { type: "integer", nullable: true, example: 2 }
					}
				},
				TransactionItem: {
					type: "object",
					required: ["id", "transactionId", "menuId", "qty", "price"],
					properties: {
						id: { type: "integer", example: 10 },
						transactionId: { type: "integer", example: 1 },
						menuId: { type: "integer", example: 5 },
				...
				UpdateTransactionItemRequest: {
					...
					properties: {
						...
						discount: { type: "number", nullable: true, example: 1000 }
					}
				},
				TransactionItemVariant: {
					type: "object",
					required: ["id", "transactionItemId", "menuVariantId"],
					properties: {
						id: { type: "integer", example: 100 },
						transactionItemId: { type: "integer", example: 10 },
						menuVariantId: { type: "integer", example: 7 },
						extraPrice: { type: "number", example: 3000 }
					}
				},
				CreateTransactionItemVariantRequest: {
					type: "object",
					required: ["transactionItemId", "menuVariantId"],
					properties: {
						transactionItemId: { type: "integer", example: 10 },
						menuVariantId: { type: "integer", example: 7 },
						extraPrice: { type: "number", example: 3000 }
				...
				CreateKitchenOrderRequest: {
					...
					properties: {
						transactionItemId: { type: "integer", example: 10 },
						status: { type: "string", nullable: true, example: "waiting" },
						startedAt: { type: "string", format: "date-time", nullable: true },
						finishedAt: { type: "string", format: "date-time", nullable: true },
						note: { type: "string", nullable: true }
					}
				...
				ActivityLog: {
					...
					properties: {
						...
						action: { type: "string", example: "create_order" },
						entityType: { type: "string", nullable: true, example: "order" },
						entityId: { type: "integer", nullable: true, example: 101 },
						contextJson: { type: "object", nullable: true },
						createdAt: { type: "string", format: "date-time" }
					}
				},
				...
				SystemLog: {
					...
					properties: {
						id: { type: "integer", example: 1 },
						level: { type: "string", nullable: true, example: "error" },
						message: { type: "string", example: "Unhandled exception" },
						contextJson: { type: "object", nullable: true },
						createdAt: { type: "string", format: "date-time" }
					}
				},
				...
				ReportFile: {
					...
					properties: {
						...
						reportScope: { type: "string", example: "daily" },
						reportDate: { type: "string", format: "date-time", nullable: true },
						placeId: { type: "integer", nullable: true },
						fileName: { type: "string", example: "sales-2025-01-01.csv" },
						filePath: { type: "string", example: "/reports/sales-2025-01-01.csv" },
						createdAt: { type: "string", format: "date-time" }
					}
				},
				...
				DeliveryIntegration: {
					...
					properties: {
						id: { type: "integer", example: 1 },
						placeId: { type: "integer", example: 1 },
						platformName: { type: "string", example: "GoFood" },
						apiKey: { type: "string", nullable: true, example: "secret" },
						settingsJson: { type: "object", nullable: true, example: { region: "ID" } }
					}
				},
				CreateDeliveryIntegrationRequest: {
					type: "object",
					required: ["placeId", "platformName"],
					properties: {
						placeId: { type: "integer", example: 1 },
						platformName: { type: "string", example: "GrabFood" },
						apiKey: { type: "string", nullable: true },
						settingsJson: { type: "object", nullable: true }
					}
				},
				UpdateDeliveryIntegrationRequest: {
					...
					properties: {
						placeId: { type: "integer", example: 1 },
						platformName: { type: "string", example: "ShopeeFood" },
						apiKey: { type: "string", nullable: true },
						settingsJson: { type: "object", nullable: true }
					}
				},
				PaymentMethod: {
					...
					properties: {
						...
						description: { type: "string", nullable: true, example: "Tunai" },
				...
				UpdatePaymentMethodRequest: {
					...
					properties: {
						...
						description: { type: "string", nullable: true, example: "QRIS" },
						isActive: { type: "boolean", example: true }
					}
				},
				MenuVariant: {
					type: "object",
					required: ["id", "menuId", "name"],
					properties: {
						id: { type: "integer", example: 1 },
				...
				CreateMenuVariantRequest: {
					...
					properties: { menuId: { type: "integer", example: 1 }, name: { type: "string", example: "Size" } }
				},
				UpdateMenuVariantRequest: {
					...
					properties: {
						menuId: { type: "integer", example: 1 },
						name: { type: "string", example: "Tingkat Pedas" }
					}
				},
				MenuVariantItem: {
					type: "object",
					...
					properties: {
						id: { type: "integer", example: 1 },
						menuVariantId: { type: "integer", example: 1 },
				...
				Recipe: {
					type: "object",
					required: ["id", "menuId", "ingredientId", "qty"],
					properties: {
						id: { type: "integer", example: 1 },
						menuId: { type: "integer", example: 1 },
